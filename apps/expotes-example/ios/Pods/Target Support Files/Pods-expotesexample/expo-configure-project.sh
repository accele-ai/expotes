...
with_node \
  ...
  --target "/Users/Xuan/Projects/accele-ai/expotes/apps/expotes-example/ios/Pods/Target Support Files/Pods-expotesexample/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-system-ui" "expo-web-browser"
